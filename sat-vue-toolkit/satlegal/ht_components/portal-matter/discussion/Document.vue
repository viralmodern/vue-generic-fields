    ...
    <v-row no-gutters class="justify-center align-center">
      ...
      <v-col cols="12" sm="2" class="text-sm-right my-2">
        <span class="text--secondary"
          >{{ (document.items || []).length }} REQUESTS</span
        >
      </v-col>
    </v-row>
...
export default {
  ...
  methods: {
    ...
    ...mapActions("ht_store/clientPortal/matter/discussionDocument", [
  ...
  computed: {
    ...mapGetters("ht_store/clientPortal/matter/discussionDocument", ["document"]),
