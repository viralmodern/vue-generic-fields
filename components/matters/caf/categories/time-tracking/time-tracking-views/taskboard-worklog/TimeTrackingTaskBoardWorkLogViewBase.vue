<template>
  <div>
    ...
    <div class="mb-4"></div>
    <v-card flat>
      <TimeTrackingTaskBoardWorkLogViewGrid
        :type="gridGroupBy"
...
import TimeTrackingTaskBoardWorkLogViewGrid from './TimeTrackingTaskBoardWorkLogViewGrid'
import TreeTaskBoardWorkLogListTask from './TreeTaskBoardWorkLogListTask'
import dateTime from '../../../../../../../mixins/mx_dateTime'
export default {
  name: 'TimeTrackingTaskBoardWorkLogViewBase',
  components: {
    TreeTaskBoardWorkLogListTask,
    TimeTrackingTaskBoardWorkLogViewGrid,
    ChooseDateUserWorkLogPicker
  },
  mixins: [dateTime],
