<template>
  <div class="example chat-bubble d-flex flex-column justify-space-between">
    <slot name="header">
      <ToolBar />
    </slot>
    <div class="list-container flex-1 overflow-hidden">
      <virtual-list
        ...
        class="stream scroll-touch fill-height"
...
import QuickRepliesLinks from '~/features/chatbot/QuickRepliesLinks'
import ToolBar from '~/features/chatbot/Toolbar'
...
export default {
  ...
  methods: {
    ...
    addItemClass(index) {
      return this.messages[index] && this.messages[index].isCreator
        ? 'creator'
        : ''
    },
