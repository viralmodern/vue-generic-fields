  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentDocumentRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackDocumentRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentDocumentRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackDocumentRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentDocumentRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackDocumentRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackDocumentRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentDocumentRequest(data);
    ...
    ...mapActions("ht_store/clients/documentRequest", [
      // comment
      "getDataCommentDocumentRequest",
      "addCommentDocumentRequest",
      "updateCommentDocumentRequest",
      "removeCommentDocumentRequest",
      // comment feedback
      "getDataCommentFeedbackDocumentRequest",
      "addCommentFeedbackDocumentRequest",
      "updateCommentFeedbackDocumentRequest",
      "removeCommentFeedbackDocumentRequest"
    ]),
    ...mapMutations("ht_store/clients/documentRequest", [
      "updateActionComment",
