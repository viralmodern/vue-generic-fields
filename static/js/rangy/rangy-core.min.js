;(function (b, a) {
  ...
  var h = {
    ...
    config: {
      ...
      autoInitialize:
        typeof rangyAutoInitialize == A ? true : rangyAutoInitialize,
    },
  }
  function H(O) {
  ...
  function m(O) {
    ...
    h.supported = false
    p(
      'Rangy is not supported in this environment. Reason: ' + O,
  ...
  function K() {
    ...
    h.initialized = true
    h.features = { implementsDomRange: X, implementsTextRange: R }
    var P, V
    for (var O in v) {
    ...
    for (var S = 0, U = N.length; S < U; ++S) {
      try {
        ...
        V =
          'Rangy init listener threw an exception. Continuing. Detail: ' + c(W)
        H(V)
      }
    }
  }
  ...
  h.createCoreModule('DomUtil', [], function (R, P) {
    ...
    function V(aD) {
      var aC
      return (
        typeof aD.namespaceURI == ah ||
        (aC = aD.namespaceURI) === null ||
    ...
    function an(aC) {
      return (
        aC && T.isHostMethod(aC, 'setTimeout') && T.isHostObject(aC, 'document')
      )
    }
    function am(aF, aD, aC) {
      ...
      if (!aF) {
        ...
        if (T.isHostProperty(aF, 'nodeType')) {
          aE =
            aF.nodeType == 1 && aF.tagName.toLowerCase() == 'iframe'
              ? aA(aF)
              : az(aF)
        } else {
          if (an(aF)) {
      ...
      if (!aE) {
        throw aD.createError(
          aC + '(): Parameter must be a Window object or DOM node'
        )
      }
      return aE
    }
    ...
    function ag(aC) {
      ...
      if (aC.nodeType == 1) {
        ...
        return (
          ...
          ac(aC) +
          ',length:' +
          aC.childNodes.length +
          '][' +
          (aC.innerHTML || '[innerHTML not supported]').slice(0, 25) +
          ']'
        )
      }
      return aC.nodeName
  ...
  h.createCoreModule('DomRange', ['DomUtil'], function (ad, a7) {
    ...
    function aR(ba, a9) {
      return (
        ba.nodeType != 3 &&
        (ay(ba, a9.startContainer) || ay(ba, a9.endContainer))
      )
    }
    function aY(a9) {
    ...
    function ae(bb) {
      var ba
      for (
        var bc, bd = aY(bb.range).createDocumentFragment(), a9;
        (bc = bb.next());
    ...
    function aU(ba) {
      for (
        var bb, bc = aY(ba.range).createDocumentFragment(), a9;
        (bb = ba.next());
    ...
    function a2(a9) {
      ...
      return (
        ...
        ba +
        '(' +
        ag.inspectNode(a9.startContainer) +
        ':' +
        a9.startOffset +
        ', ' +
        ag.inspectNode(a9.endContainer) +
        ':' +
        a9.endOffset +
        ')]'
      )
      ...
      if (!bb.collapsed) {
        ...
        if (this.sc === this.ec && az(this.sc)) {
          ...
          this._first = this._next =
            this.sc === a9 && !az(this.sc)
              ? this.sc.childNodes[this.so]
              : aP(this.sc, a9, true)
          this._last =
            this.ec === a9 && !az(this.ec)
      ...
      next: function () {
        ...
        if (a9) {
          ...
          if (az(a9) && this.clonePartiallySelectedTextNodes) {
            if (a9 === this.ec) {
              ;(a9 = a9.cloneNode(true)).deleteData(
                this.eo,
                a9.length - this.eo
              )
            }
    ...
    function aq(a9) {
      return (
        ...
        !(
          ak &&
          (ag.isBrokenNode(a9.startContainer) ||
            ag.isBrokenNode(a9.endContainer))
        ) &&
        ah(a9.startContainer) == ah(a9.endContainer) &&
        V(a9.startContainer, a9.startOffset) &&
        V(a9.endContainer, a9.endOffset)
      )
    }
    function P(a9) {
      if (!aq(a9)) {
    ...
    var ai = ax
      ? function (bb) {
          ...
          if (
            a9 === null ||
            (a9.nodeName == 'HTML' &&
              ag.isHtmlNamespace(a8(a9).documentElement) &&
              ag.isHtmlNamespace(a9))
          ) {
    ...
    aV.extend(ad.rangePrototype, {
      ...
      canSurroundContents: function () {
        ...
        var a9 = new aj(this, true)
        var ba =
          (a9._first && aR(a9._first, this)) || (a9._last && aR(a9._last, this))
        a9.detach()
        return !ba
      },
      ...
      toString: function () {
        ...
        if (bb === this.endContainer && az(bb)) {
          return bb.nodeType == 3 || bb.nodeType == 4
            ? bb.data.slice(this.startOffset, this.endOffset)
            : ''
        } else {
          var a9 = [],
            ba = new aj(this, true)
      ...
      isPointInRange: function (a9, ba) {
        ...
        aO(a9, this.startContainer)
        return (
          aX(a9, ba, this.startContainer, this.startOffset) >= 0 &&
          aX(a9, ba, this.endContainer, this.endOffset) <= 0
        )
      },
      ...
      containsNodeContents: function (a9) {
        return (
          this.comparePoint(a9, 0) >= 0 && this.comparePoint(a9, aC(a9)) <= 0
        )
      },
      ...
      getBookmark: function (a9) {
        ...
        return { start: be, end: ba, containerNode: a9 }
      },
    ...
    function Z(ba, be) {
      ...
      aV.extend(ba.prototype, {
        ...
        canSurroundContents: function () {
          ...
          var bg =
            (bf._first && aR(bf._first, this)) ||
            (bf._last && aR(bf._last, this))
          bf.detach()
          return !bg
        },
    ...
    function at(a9) {
      a9.collapsed =
        a9.startContainer === a9.endContainer && a9.startOffset === a9.endOffset
      a9.commonAncestorContainer = a9.collapsed
        ? a9.startContainer
        : ag.getCommonAncestor(a9.startContainer, a9.endContainer)
    }
    ...
    aV.extend(ap, {
      ...
      rangesEqual: function (ba, a9) {
        return (
          ba.startContainer === a9.startContainer &&
          ba.startOffset === a9.startOffset &&
          ba.endContainer === a9.endContainer &&
          ba.endOffset === a9.endOffset
        )
      },
    })
    ad.DomRange = ap
  ...
  h.createCoreModule('WrappedRange', ['DomRange'], function (aa, S) {
    ...
    if (aa.features.implementsDomRange) {
      ;(function () {
        ...
        function af(ar) {
          ...
          ar.collapsed =
            ar.startContainer === ar.endContainer &&
            ar.startOffset === ar.endOffset
        }
        ...
        aq.setStart(ao, 2)
        if (
          al.compareBoundaryPoints(al.START_TO_END, aq) == -1 &&
          al.compareBoundaryPoints(al.END_TO_START, aq) == 1
        ) {
    ...
    if (aa.features.implementsTextRange) {
      ...
      var U = function (af, ar, ap, ag, aj) {
        ...
        if (!ah.canHaveHTML) {
          ...
          return {
            boundaryPosition: ao,
            nodeInfo: { nodeIndex: ao.offset, containerElement: ao.node },
          }
        }
        ...
        return {
          boundaryPosition: aq,
          nodeInfo: { nodeIndex: ay, containerElement: ah },
        }
      }
    ...
    X.createAliasForDeprecatedMethod(
      aa,
  ...
  h.createCoreModule(
    ...
    function (X, R) {
      ...
      var aw = aV(document)
      var aF = ac.areHostProperties(aI, [
        'anchorNode',
        'focusNode',
        'anchorOffset',
        'focusOffset',
      ...
      var ao = ag
        ...
        : null
      if (
        ac.areHostMethods(aI, ['addRange', 'getRangeAt', 'removeAllRanges']) &&
        typeof aI.rangeCount == aA &&
        ab.implementsDomRange
      ) {
        ;(function () {
      ...
      if (aF) {
        ae = function (aZ) {
          return (
            aZ.anchorNode === aZ.focusNode && aZ.anchorOffset === aZ.focusOffset
          )
        }
      } else {
        ae = function (aZ) {
          return aZ.rangeCount
            ? aZ.getRangeAt(aZ.rangeCount - 1).collapsed
            : false
        }
      }
      function P(a1, aZ, a2) {
      ...
      function aE(aZ) {
        ...
        if (aZ instanceof aP) {
          ...
          if (aZ instanceof T) {
            ...
            if (
              ab.implementsDomRange &&
              aZ instanceof Q.getWindow(aZ.startContainer).Range
            ) {
              a0 = aZ
            }
          }
      ...
      if (ak) {
        ...
        if (aL(aI, 'getRangeAt') && typeof aI.rangeCount == aA) {
            ...
            if (W && aJ && a1.docSelection.type == aX) {
              ...
              if (a1.rangeCount) {
                for (var a0 = 0, aZ = a1.rangeCount; a0 < aZ; ++a0) {
                  a1._ranges[a0] = new X.WrappedRange(
                    a1.nativeSelection.getRangeAt(a0)
                  )
                }
          ...
          if (
            aF &&
            typeof aI.isCollapsed == ax &&
            typeof av.collapsed == ax &&
            ab.implementsDomRange
          ) {
            ay = function (a1) {
              var aZ,
                a0 = a1.nativeSelection
              if (a0.anchorNode) {
                aZ = af(a0, 0)
                a1._ranges = [aZ]
                a1.rangeCount = 1
