...
export default {
  ...
  methods: {
    ...mapActions("ht_store/clientPortal/matter/billingPayment", [
      "getDataPaymentRequest",
      "updatePaymentRequest",
      "deletePaymentRequest",
      "addPaymentRequest"
    ]),
    ...mapActions("ht_store/clientPortal/matter/billingInvoice", ["getDataInvoiceRequest"]),
    ...mapActions("ht_store/workspace/client", ["getDataClientRequest"])
  },
  computed: {
    ...mapGetters("ht_store/workspace/client", ["dataClient"]),
    ...mapGetters("ht_store/clientPortal/matter/billingInvoice", ["dataInvoice"]),
    ...mapGetters("ht_store/clientPortal/matter/billingPayment", ["payment"])
  },
  mounted() {
