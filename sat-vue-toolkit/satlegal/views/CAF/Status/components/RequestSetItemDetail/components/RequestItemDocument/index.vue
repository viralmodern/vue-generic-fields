            ...
            <template v-slot:item.action="{ props: { item } }">
              <div class="d-flex">
                <BookmarkOrFlag
                  ...
                  :endpoint="`/api/matters/${$$$matterID}/request-sets/${$route.params.requestSetId}/items/${itemsId}/documents/${item.pk}`"
                  routerMutation="ht_store/matter/requestStatus/requestSetsItemDocument/updateDataRSID"
                  :pk="item.pk"
