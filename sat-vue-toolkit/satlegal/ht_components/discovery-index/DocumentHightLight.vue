  ...
  <div>
    ...
    <div>
      ...
      <AddInline
        ...
        hint="Enter to add new higthlight"
      />
    </div>
  </div>
</template>
...
import TableHightLightIndexDetail from "./TableHightLightIndexDetail";
