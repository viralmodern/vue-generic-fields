  ...
  methods: {
    async add({ dataForm, closeAdd }) {
      ...
      try {
        ...
        await this.addPrivilegeLabelRequest({
    ...
    async update({ dataForm, closeUpdate }) {
      try {
        ...
        await this.updatePrivilegeLabelRequest({
          matterId: this.$route.params.matter || this.$route.params.projectId,
          ...dataForm
        });
    ...
    removeLabel(id) {
      ...
      this.removePrivilegeLabelRequest({ matterId: this.$route.params.matter || this.$route.params.projectId, id })
    }
  }
};
</script>
