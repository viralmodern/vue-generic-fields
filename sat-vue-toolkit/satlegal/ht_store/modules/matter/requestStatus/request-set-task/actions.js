import api from "@/sat-vue-toolkit/satlegal/api/matter/requestStatus/requestSetTask";
import {
...
export default {
  ...
  async getRequestSetTaskDetailRequest({ commit }, idParams) {
    const result = await api.getRequestSetTaskDetail(idParams);
    commit("getRequestSetTaskDetail", result);
    return result;
  },

  async updateRequestSetTaskRequest({ commit }, { idParams, body, detail = false }) {
    api.updateRequestSetTask({ idParams, body });
    const map = {
      result: { pk: idParams.requestSetTaskId, ...body }
    };
    if (detail) {
      commit("updateDataRequestSetTaskDetail", map)
  ...
  async removeRequestItemInTaskRequest({ commit }, data) {
    ...
    if (data.detail) {
      ...
      commit("removeRequestItemInTaskDetail", map);
    } else {
      commit("removeRequestItemInTask", map);
    }
  },
  ...
  async addNotesRequestSetTaskRequest({ commit }, data = {}) {
    ...
    if (data.detail) {
      commit("updateDataRequestSetTaskDetail", body);
    }
  ...
  async addCommentRequestSetTaskRequest({ commit }, data = {}) {
    ...
    if (data.detail) {
      commit("updateDataRequestSetTaskDetail", dataRequestSetTask);
    }
