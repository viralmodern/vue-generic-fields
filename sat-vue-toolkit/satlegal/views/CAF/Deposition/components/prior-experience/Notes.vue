...
export default {
  ...
  props: {
    ...
    priorExperienceId: [String, Number],
  ...
  methods: {
    async addNotes({ body, page }) {
      const data = {
        idParams: {
          ...
          priorExperienceId: this.priorExperienceId,
        },
      ...
      try {
        ...
        await this.addNotesPriorExperienceRequest(data);
    ...
    async editNotes({ body, page, id }) {
      ...
      try {
        this.isLoadingAdd = true;
        await this.updateNotesPriorExperienceRequest(data);
    ...
    async removeNotes({ id, page }) {
      ...
      await this.removeNotesPriorExperienceRequest(data);
      this.getDataNotes(page);
    },
    async getDataNotes(page) {
      ...
      await this.getDataNotesPriorExperienceRequest(data);
      this.isLoadingGet = false;
    },
    ...mapActions("ht_store/matter/deposition/priorExperience", [
      "getDataNotesPriorExperienceRequest",
      "addNotesPriorExperienceRequest",
      "removeNotesPriorExperienceRequest",
      "updateNotesPriorExperienceRequest"
    ])
  }
};
</script>
