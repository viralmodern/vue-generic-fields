  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentSubpoenaSetRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackSubpoenaSetRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentSubpoenaSetRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackSubpoenaSetRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentSubpoenaSetRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackSubpoenaSetRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackSubpoenaSetRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentSubpoenaSetRequest(data);
    ...
    ...mapActions("ht_store/matter/subpoena/subpoenaSet", [
      // comment
      "getDataCommentSubpoenaSetRequest",
      "addCommentSubpoenaSetRequest",
      "updateCommentSubpoenaSetRequest",
      "removeCommentSubpoenaSetRequest",
      // comment feedback
      "getDataCommentFeedbackSubpoenaSetRequest",
      "addCommentFeedbackSubpoenaSetRequest",
      "updateCommentFeedbackSubpoenaSetRequest",
      "removeCommentFeedbackSubpoenaSetRequest"
    ]),
    ...mapMutations("ht_store/matter/subpoena/subpoenaSet", [
      "updateActionComment",
