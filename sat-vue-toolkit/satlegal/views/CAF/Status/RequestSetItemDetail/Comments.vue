  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentRSIDRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackRSIDRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentRSIDRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackRSIDRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentRSIDRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackRSIDRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackRSIDRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentRSIDRequest(data);
    ...
    ...mapActions("ht_store/matter/requestStatus/requestSetsItemDocument", [
      // comment
      "getDataCommentRSIDRequest",
      "addCommentRSIDRequest",
      "updateCommentRSIDRequest",
      "removeCommentRSIDRequest",
      // comment feedback
      "getDataCommentFeedbackRSIDRequest",
      "addCommentFeedbackRSIDRequest",
      "updateCommentFeedbackRSIDRequest",
      "removeCommentFeedbackRSIDRequest",
    ]),
    ...mapMutations("ht_store/matter/requestStatus/requestSetsItemDocument", [
      "updateActionComment",
