<template>
  <MenuListLabel
    ...
    @update="update"
    @remove="
      removeIssuesRequest({ matterId:$route.params.matter || $route.params.projectId, id: $event })
    "
  ...
  methods: {
    ...
    async add({dataForm, closeAdd}) {
      try {
        ...
        await this.addIssuesRequest({ matterId: this.$route.params.matter || this.$route.params.projectId, ...dataForm });
    ...
    async update({dataForm, closeUpdate}) {
      try {
        ...
        await this.updateIssuesRequest({ matterId: this.$route.params.matter || this.$route.params.projectId, ...dataForm });
