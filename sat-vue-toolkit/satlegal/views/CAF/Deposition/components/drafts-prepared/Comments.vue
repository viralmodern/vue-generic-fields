  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentDraftsRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackDraftsRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentDraftsRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackDraftsRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentDraftsRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackDraftsRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackDraftsRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentDraftsRequest(data);
    ...
    ...mapActions("ht_store/matter/deposition/draftsPrepare", [
      // comment
      "getDataCommentDraftsRequest",
      "addCommentDraftsRequest",
      "updateCommentDraftsRequest",
      "removeCommentDraftsRequest",
      // comment feedback
      "getDataCommentFeedbackDraftsRequest",
      "addCommentFeedbackDraftsRequest",
      "updateCommentFeedbackDraftsRequest",
      "removeCommentFeedbackDraftsRequest"
    ]),
