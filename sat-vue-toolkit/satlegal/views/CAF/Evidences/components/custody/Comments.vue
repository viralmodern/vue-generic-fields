  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentEvidencesCustodyRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackEvidencesCustodyRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentEvidencesCustodyRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackEvidencesCustodyRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentEvidencesCustodyRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackEvidencesCustodyRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackEvidencesCustodyRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentEvidencesCustodyRequest(data);
    ...
    ...mapActions("ht_store/matter/evidencesCustody", [
      // comment
      "getDataCommentEvidencesCustodyRequest",
      "addCommentEvidencesCustodyRequest",
      "updateCommentEvidencesCustodyRequest",
      "removeCommentEvidencesCustodyRequest",
      // comment feedback
      "getDataCommentFeedbackEvidencesCustodyRequest",
      "addCommentFeedbackEvidencesCustodyRequest",
      "updateCommentFeedbackEvidencesCustodyRequest",
      "removeCommentFeedbackEvidencesCustodyRequest",
    ]),
    ...mapMutations("ht_store/matter/evidencesCustody", [
      "updateActionComment",
