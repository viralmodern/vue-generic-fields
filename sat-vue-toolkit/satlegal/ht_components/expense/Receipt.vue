...
export default {
  ...
  methods: {
    ...
    ...mapActions("ht_store/workspace/billing/expense/receipt", [ // eslint-disable-line
  ...
  computed: {
    ...
    ...mapGetters("ht_store/workspace/billing/expense/receipt", ["dataAttachment"]) // eslint-disable-line
  }
};
</script>
