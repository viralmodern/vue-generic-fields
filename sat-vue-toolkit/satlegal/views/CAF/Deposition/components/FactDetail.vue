        ...
        <v-list dense>
          <v-form ref="form" v-model="valid">
            <v-row class="pa-0 ma-0">
              ...
              <v-col cols="6">
                <SelectChip
                  :items="appConfigChoices[appConfigConstants.FAVORABLE_AND_PROVIDEDBY]"
                  label="Favorable"
                  item-text="label"
                  item-value="value"
...
import DateMonthPicker from "@/sat-vue-toolkit/satlegal/ht_components/menus/DateMonthPicker";
...
export default {
  ...
  methods: {
    ...mapActions("ht_store/matter/deposition/fact", ["updateFactDetailRequest"]),
    save() {
  ...
  computed: {
    ...mapGetters("ht_store/matter/deposition/fact", [
      "factDetail",
      "isLoadingGetDetail"
    ]),
