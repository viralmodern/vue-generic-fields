  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentPriorExperienceRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackPriorExperienceRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentPriorExperienceRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackPriorExperienceRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentPriorExperienceRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackPriorExperienceRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackPriorExperienceRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentPriorExperienceRequest(data);
    ...
    ...mapActions("ht_store/matter/deposition/priorExperience", [
      // comment
      "getDataCommentPriorExperienceRequest",
      "addCommentPriorExperienceRequest",
      "updateCommentPriorExperienceRequest",
      "removeCommentPriorExperienceRequest",
      // comment feedback
      "getDataCommentFeedbackPriorExperienceRequest",
      "addCommentFeedbackPriorExperienceRequest",
      "updateCommentFeedbackPriorExperienceRequest",
      "removeCommentFeedbackPriorExperienceRequest"
    ]),
