...
export default {
  ...
  computed: {
    ...
    ...mapGetters("ht_store/matter/citations/detail/comment", ["dataComments"]) // eslint-disable-line
  },
  methods: {
    ...
    ...mapActions("ht_store/matter/citations/detail/comment", [ // eslint-disable-line
      "sendCommentRequest"
    ])
  }
};
