  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentRequestSetTaskRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackRequestSetTaskRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentRequestSetTaskRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackRequestSetTaskRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentRequestSetTaskRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackRequestSetTaskRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackRequestSetTaskRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentRequestSetTaskRequest(data);
    ...
    ...mapActions("ht_store/matter/requestStatus/requestSet/task", [
      // comment
      "getDataCommentRequestSetTaskRequest",
      "addCommentRequestSetTaskRequest",
      "updateCommentRequestSetTaskRequest",
      "removeCommentRequestSetTaskRequest",
      // comment feedback
      "getDataCommentFeedbackRequestSetTaskRequest",
      "addCommentFeedbackRequestSetTaskRequest",
      "updateCommentFeedbackRequestSetTaskRequest",
      "removeCommentFeedbackRequestSetTaskRequest",
    ]),
    ...mapMutations("ht_store/matter/requestStatus/requestSet/task", [
      "updateActionComment",
