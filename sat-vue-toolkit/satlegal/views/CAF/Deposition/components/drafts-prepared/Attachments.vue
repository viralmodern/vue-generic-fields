  ...
  methods: {
    async addFiles(payload) {
      ...
      try {
        ...
        await this.addAttachmentDraftRequest(data);
    ...
    async updateAttachment(payload) {
      ...
      try {
        ...
        await this.updateAttachmentDraftRequest(data);
    ...
    removeAttachment(payload) {
      ...
      this.removeAttachmentDraftRequest(data);
    },
    ...mapActions("ht_store/matter/deposition/draftsPrepare", [
      "addAttachmentDraftRequest",
      "updateAttachmentDraftRequest",
      "removeAttachmentDraftRequest"
    ])
  }
};
</script>
