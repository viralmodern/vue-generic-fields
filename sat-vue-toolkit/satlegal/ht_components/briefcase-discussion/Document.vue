<template>
  <div class="mt-2">
    <v-row no-gutters class="justify-center align-center">
      ...
      <v-col cols="12" sm="6">
        <ProgressMultiColor :list="document.progressList" keyProgress="progress" keyColor="color" />
      </v-col>
...
import TdAction from "../document-discussion/TdAction";
import TdDueDate from "../document-discussion/TdDueDate";
import TdName from "../document-discussion/TdName";
import TdRequester from "../document-discussion/TdRequester";
import TdDescription from "../document-discussion/TdDescription";
import TdMatter from "../document-discussion/TdMatter";
...
export default {
  ...
  methods: {
    ...
    ...mapActions("ht_store/matter/briefcase/discussion/document", [
  ...
  computed: {
    ...mapGetters("ht_store/matter/briefcase/discussion/document", ["document"]),
