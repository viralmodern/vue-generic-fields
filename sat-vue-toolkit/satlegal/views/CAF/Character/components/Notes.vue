  ...
  methods: {
    async addNotes({ body, page }) {
      ...
      try {
        ...
        await this.addNotesCharacterRequest(data);
    ...
    async editNotes({ body, page, id }) {
      ...
      try {
        this.isLoadingAdd = true;
        await this.updateNotesCharacterRequest(data);
    ...
    async removeNotes({ id, page }) {
      ...
      await this.removeNotesCharacterRequest(data);
      this.getDataNotes(page);
    },
    async getDataNotes(page) {
      ...
      await this.getDataNotesCharacterRequest(data);
      this.isLoadingGet = false;
    },
    ...mapActions("ht_store/matter/character2", [
      "getDataNotesCharacterRequest",
      "addNotesCharacterRequest",
      "removeNotesCharacterRequest",
      "updateNotesCharacterRequest"
    ])
  }
};
</script>
