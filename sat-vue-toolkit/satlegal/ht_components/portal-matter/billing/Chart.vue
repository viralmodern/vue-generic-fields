<template>
  <v-card>
    <v-row no-gutters>
      <v-row no-gutters>
        <v-col cols="4">
          <CardTotalOfCharts @getYear="getYear" :totalChartOfCard="dataSeriesPie.totalChartOfCard" />
        </v-col>
        <v-col cols="8">
          <v-row no-gutters>
            <v-col cols="12">
            ...
            <v-col cols="12">
              <LineChart
                v-if="dataSeriesLine.length > 0"
                idLineChart="BriefcaseLineChart"
                title="Received"
...
import CardTotalOfCharts from "../../cards/CardTotalOfCharts";
export default {
  components: {
    BarChart,
    PieChart,
  ...
  computed: {
    ...mapGetters("ht_store/clientPortal/matter/billingInvoice/chart", [
      "dataChartOfSummary"
    ]),
    nameClient() {
  ...
  methods: {
    ...mapActions("ht_store/clientPortal/matter/billingInvoice/chart", [
      "getDataChartSummary"
    ]),
