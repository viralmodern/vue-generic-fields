...
<script>
  ...
  export default {
    ...
    data() {
      return {
        headerLayout: LAYOUT_TYPES.LIST.HEADER_LAYOUT,
        rowLayout: LAYOUT_TYPES.LIST.ROW_LAYOUT,
      }
    },
    components: {
      BaseHeaderListItem:() => import("~/sat-vue-toolkit/components/slick-grid/headers/BaseHeaderListItem"),
      BaseRowListItem: () => import("~/sat-vue-toolkit/components/slick-grid/rows/BaseRowListItem"),
