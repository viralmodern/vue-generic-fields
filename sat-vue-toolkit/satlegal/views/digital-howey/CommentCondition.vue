<template>
  <div>
    <TicketComments :comments="dataComments" :mentions="dataCharacterMap" @send="sendComment"/>
  </div>
</template>
<script>
import { mapActions, mapGetters } from "vuex";
import TicketComments from "../../ht_components/messages/TicketComments";
...
export default {
  ...
  computed: {
    ...
    ...mapGetters("ht_store/matter/digitalHowey/condition/comment", ["dataComments"])
  },
  methods: {
    ...
    ...mapActions("ht_store/matter/digitalHowey/condition/comment", ["sendCommentRequest"])
  }
};
</script>
