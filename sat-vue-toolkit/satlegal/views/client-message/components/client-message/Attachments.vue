  ...
  methods: {
    async addFiles(payload) {
      ...
      try {
        ...
        await this.addAttachmentClientMessageRequest(data);
    ...
    async updateAttachment(payload) {
      ...
      try {
        ...
        await this.updateAttachmentClientMessageRequest(data);
    ...
    removeAttachment(payload) {
      ...
      this.removeAttachmentClientMessageRequest(data);
    },
    ...mapActions("ht_store/clients/clientMessage", [
      "addAttachmentClientMessageRequest",
      "updateAttachmentClientMessageRequest",
      "removeAttachmentClientMessageRequest",
    ]),
  },
};
</script>
