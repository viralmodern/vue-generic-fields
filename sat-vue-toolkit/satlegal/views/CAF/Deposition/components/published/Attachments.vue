  ...
  methods: {
    async addFiles(payload) {
      ...
      try {
        ...
        await this.addAttachmentPublishedRequest(data);
    ...
    async updateAttachment(payload) {
      ...
      try {
        ...
        await this.updateAttachmentPublishedRequest(data);
    ...
    removeAttachment(payload) {
      ...
      this.removeAttachmentPublishedRequest(data);
    },
    ...mapActions("ht_store/matter/deposition/published", [
      "addAttachmentPublishedRequest",
      "updateAttachmentPublishedRequest",
      "removeAttachmentPublishedRequest",
    ]),
  },
};
</script>
