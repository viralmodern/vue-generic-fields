<template>
  <div class="px-2">
    ...
    <div v-if="items.type === 'evidences'">
      <Disputes
        :disputed="items.disputed"
        @update="change('disputed', $event)"
      />
      <v-divider></v-divider>
    </div>
    <div v-if="items.type === 'evidences'">
    ...
    <div v-if="items.type === 'testimony'">
      <SwitchRow
        text="Under Oath"
        :value="items.underOath"
        @update="change('underOath', $event)"
      />
      <v-divider></v-divider>
    </div>
    <v-row no-gutters class="pa-2 align-center">
      ...
      <v-col cols="6" class="text-xs-center">
        <EvidencesDetailOriginial
          :originial="items.originial"
          @update="change('originial', $event)"
        />
      </v-col>
    </v-row>
    <v-divider></v-divider>
    ...
    <v-row no-gutters class="pa-2">
      ...
      <v-col cols="9" class="label text-xs-center align-center">
        <EvidencesDetailTag :tag="items.tag" />
      </v-col>
    </v-row>
    <v-divider></v-divider>
  </div>
...
import EvidencesDetailTag from "./EvidencesDetailTag";
import EvidencesDetailOriginial from "./EvidencesDetailOriginial";
