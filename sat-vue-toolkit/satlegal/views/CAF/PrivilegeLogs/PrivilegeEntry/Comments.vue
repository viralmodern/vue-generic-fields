  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentPrivilegeRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackPrivilegeRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentPrivilegeRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackPrivilegeRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentPrivilegeRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackPrivilegeRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackPrivilegeRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentPrivilegeRequest(data);
    ...
    ...mapActions("ht_store/matter/privilege", [
      // comment
      "getDataCommentPrivilegeRequest",
      "addCommentPrivilegeRequest",
      "updateCommentPrivilegeRequest",
      "removeCommentPrivilegeRequest",
      // comment feedback
      "getDataCommentFeedbackPrivilegeRequest",
      "addCommentFeedbackPrivilegeRequest",
      "updateCommentFeedbackPrivilegeRequest",
      "removeCommentFeedbackPrivilegeRequest",
    ]),
    ...mapMutations("ht_store/matter/privilege", [
      "updateActionComment",
