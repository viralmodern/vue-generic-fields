        ...
        <v-expansion-panel-content>
          ...
          <div class="d-flex mt-2 align-center">
            <v-col cols="10" class="pa-0">
              <FormCreateRequestSetExpenseDetail
...
import RequestSetExpenseDetail from "../components/RequestSetExpenseDetail/index";

//form
import FormCreateRequestSetExpenseDetail from "../components/request-set-expense-detail/FormCreateRequestSetExpenseDetail";
...
export default {
  ...
  data() {
    return {
      ...
      headers: [
        ...
        { text: "Request Number", value: "object_id", active: true },
  ...
  computed: {
    ...
    ...mapGetters("ht_store/matter/requestStatus/requestSet/expense", [
  ...
  methods: {
    ...
    async updatePagination(searchObject, isFirstCall) {
      const constantRequestSetRelated = this.appConfigListContentType[
        this.appConfigConstants.REQUEST_SET_RELATED
      ];
      const defaultSearchObject = {
        ...searchObject,
        content_type: constantRequestSetRelated
          ? constantRequestSetRelated.value
          : "",
    ...
    ...mapActions("ht_store/matter/requestStatus/requestSet/expense", [
