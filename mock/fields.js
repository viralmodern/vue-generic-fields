...
export const fields = [
  ...
  { text: 'Actions', value: 'action', active: true, pos: 25 },
]
...
export const ALL_CAF = [
  ...
  //  todo: Case Investigation
  {
    ...
    id: 'Investigation Case Management_caf',
  ...
  },
  {
    ...
    id: 'Legal Analysis (Citations)_caf',
  ...
  },
  {
    ...
    id: 'Discovery Request Status_caf',
    path: '',
    color: COLORS[6],
    caf_type: 'Pretrials',
  },
  ...
  },
  {
    ...
    id: 'DMS - Docs Available to Opposing Counsel_caf',
    path: '',
    featured: true,
    color: COLORS[1],
    caf_type: 'Document Management',
  },
  {
    ...
    id: 'DMS - Docs Production Received from Opposing Counsel_caf',
    path: '',
    color: COLORS[9],
    caf_type: 'Document Management',
  },
  {
    ...
    id: 'DMS - All upload attachments_caf',
    path: '',
    color: COLORS[17],
    caf_type: 'Document Management',
  },
  ...
  },
  {
    ...
    id: 'Plaintiff Evidence Presentation_caf',
    path: '',
    color: COLORS[10],
    caf_type: 'Trials',
  },
  {
    ...
    id: 'Witness Direct Examination_caf',
    path: '',
    color: COLORS[11],
    caf_type: 'Trials',
  },
  {
    ...
    id: 'Witness Cross Examination_caf',
    path: '',
    featured: true,
    color: COLORS[12],
    caf_type: 'Trials',
  ...
  },
  {
    ...
    id: 'Defendant Evidence Presentation_caf',
    path: '',
    color: COLORS[14],
    caf_type: 'Trials',
  },
  ...
  },
  {
    ...
    id: 'Expense Entries_caf',
    path: 'Expense Entries',
    color: COLORS[8],
    caf_type: 'Case Managements',
    to_model: 'expenses.expense',
  },
  // todo: Settlements
  {
    text: 'Decision Analysis',
    id: 'decision_analysis_caf',
    path: '',
    color: COLORS[16],
...
export const getCodeFieldsTree = ({ code, list, itemValue = 'id' }) => {
  let TreeModel = require('tree-model')
  let tree = new TreeModel()
  let root = tree.parse({ [itemValue]: 7489, children: list })
  return root.all(function (node) {
    return node.model[itemValue] === code
  })
}
