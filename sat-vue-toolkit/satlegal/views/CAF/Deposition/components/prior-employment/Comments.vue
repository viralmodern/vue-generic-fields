  ...
  methods: {
    ...
    async getDataComment(query) {
      try {
        ...
        await this.getDataCommentPriorEmploymentRequest(data);
    ...
    async getDataCommentFeedback(parentId, query) {
      ...
      await this.getDataCommentFeedbackPriorEmploymentRequest(data);
    },
    ...
    onSubmitEditComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.updateCommentPriorEmploymentRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.idParams.commentId = commentFeedbackId;
        this.updateCommentFeedbackPriorEmploymentRequest(data);
        return;
      }
    },
    onDeleteComment(payload) {
      ...
      if (type === TYPE_COMMENT) {
        ...
        this.removeCommentPriorEmploymentRequest(data);
        return;
      }
      if (type === TYPE_FEEDBACK) {
        data.commentId = itemCommentFeedback.pk;
        this.removeCommentFeedbackPriorEmploymentRequest(data);
        return;
      }
    },
    async onSendComment(payload) {
      ...
      if (type === TYPE_FEEDBACK) {
        this.addCommentFeedbackPriorEmploymentRequest(data);
        return;
      }
    },
    async addDataComment(data) {
      try {
        ...
        await this.addCommentPriorEmploymentRequest(data);
    ...
    ...mapActions("ht_store/matter/deposition/priorEmployment", [
      // comment
      "getDataCommentPriorEmploymentRequest",
      "addCommentPriorEmploymentRequest",
      "updateCommentPriorEmploymentRequest",
      "removeCommentPriorEmploymentRequest",
      // comment feedback
      "getDataCommentFeedbackPriorEmploymentRequest",
      "addCommentFeedbackPriorEmploymentRequest",
      "updateCommentFeedbackPriorEmploymentRequest",
      "removeCommentFeedbackPriorEmploymentRequest",
    ]),
    ...mapMutations("ht_store/matter/deposition/priorEmployment", [
      "updateActionComment",
