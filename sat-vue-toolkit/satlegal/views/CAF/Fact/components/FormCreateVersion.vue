<template>
  <div>
    ...
    >
      <v-icon small>mdi-add</v-icon>New Version
    </v-btn>
    <div v-else style="position: relative">
      ...
      <v-form class="ml-9" ref="form" v-model="valid">
        <v-row class="ma-0">
          ...
          <v-col cols="2" class="pa-0 pr-2">
            <v-text-field v-model="differences" class="custom ma-0 pa-0" placeholder="Differences"></v-text-field>
          </v-col>
          <v-col>
...
export default {
  ...
  methods: {
    ...
    ...mapActions("ht_store/matter/facts", ["postVersion"])
  },
  watch: {
    isShowAdd(val) {
      if (!val) {
