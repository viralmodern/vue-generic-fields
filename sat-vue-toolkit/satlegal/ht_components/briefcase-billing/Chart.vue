...
export default {
  ...
  computed: {
    ...mapGetters("ht_store/matter/briefcase/chart", ["dataChartOfSummary"]), // eslint-disable-line
    nameClient() {
  ...
  methods: {
    ...mapActions("ht_store/matter/briefcase/chart", ["getDataChartSummary"]), // eslint-disable-line
