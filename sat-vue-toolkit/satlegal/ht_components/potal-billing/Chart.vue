<template>
  <v-card>
    <v-row no-gutters>
        ...
        <v-col cols="8">
          <v-row no-gutters>
            ...
            <LineChart
              ...
              idLineChart="PortalInvoiceChartLine"
              title="Received"
      ...
      <v-row row justify-space-between align-center>
        <v-col cols="3">
          <PieChart
            v-if="dataSeriesPie.resultToal.length > 0"
            idPieChart="PortalInvoiceChartPie"
            class="pie-Chart"
            title="Structure"
        ...
        <v-col cols="9" class="pa-2">
          <BarChart
            ...
            idBarChart="PortalInvoiceChartBar"
            :arrxAxis="arrxAxis"
...
export default {
  ...
  computed: {
    ...mapGetters("ht_store/clientPortal/billing/invoice/chart", ["dataChartOfSummary"]),
    nameClient() {
  ...
  methods: {
    ...mapActions("ht_store/clientPortal/billing/invoice/chart", [
      "getDataChartSummary"
    ]),
