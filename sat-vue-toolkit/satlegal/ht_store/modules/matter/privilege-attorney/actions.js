import api from "@/sat-vue-toolkit/satlegal/api/matter/privilege/privilege-attorney";

import { initDataPrivilegeAttorneyDetail } from "./state";
...
export default {
  ...
  async updatePrivilegeAttorneyDetailAsyncRequest({ commit }, data = {}) {
    const result = await api.updatePrivilege(data);
    const map = {
      result
    };
  ...
  async addPrivilegeRequest({ commit }, data = {}) {
    ...
    commit("addDataPrivilege", result);
    return result;
  },
  ...
  async updatePrivilegeAttorneyDetailRequest({ commit }, data) {
    api.updatePrivilege(data);
    const map = {
      result: { pk: data.idParams.id, ...data.body }
    };
  ...
  async updatePrivilegeCheckRequest({ commit }, data) {
    const result = await api.updatePrivilegeCheck(data);
    const map = {
      pk: data.idParams.id,
      body: result,
      detail: data.detail || false
    };    
    commit("updateDataPrivilegeCheck", map);
  },
  async removePrivilegeRequest({ commit }, data) {
    const result = await api.removePrivilege(data);
    commit("getDataPrivileDetail", { ...initDataPrivilegeAttorneyDetail });
    commit("removeDataPrivilege", data);
    return result;
  },

  //notes
  async getDataNotesPrivilegeRequest({ commit }, data = {}) {
    const result = await api.getDataNotesPrivilege(data);
    commit("getDataNotePrivilege", result);
    return result;
  },

  async addNotesPrivilegeRequest({ commit }, data = {}) {
    const result = await api.addNotesPrivilege(data);
    const dataPrivilege = {
      result: {
        pk: data.idParams.id,
  ...
  async updateReportRequest({ commit }, data) {
    ...
    commit("updateDataPrivilege", map);
    if (data.detail) {
      commit("setDataPrivileDetail", map.result)
    }
    return result
  },
};
