  ...
  methods: {
    async addFiles(payload) {
      ...
      try {
        ...
        await this.addAttachmentInfoRequest(data);
    ...
    async updateAttachment(payload) {
      ...
      try {
        ...
        await this.updateAttachmentInfoRequest(data);
    ...
    removeAttachment(payload) {
      ...
      this.removeAttachmentInfoRequest(data);
    },
    ...mapActions("ht_store/matter/deposition/information", [
      "addAttachmentInfoRequest",
      "updateAttachmentInfoRequest",
      "removeAttachmentInfoRequest",
    ]),
  },
};
</script>
