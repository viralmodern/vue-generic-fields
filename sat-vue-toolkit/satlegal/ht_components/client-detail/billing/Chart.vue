...
export default {
  ...
  computed: {
    ...mapGetters("ht_store/workspace/client/detail/billing/chart", [
      "dataChartOfSummary"
    ]),
    nameClient() {
  ...
  methods: {
    ...mapActions("ht_store/workspace/client/detail/billing/chart", [
      "getDataChartSummary"
    ]),
