            ...
            <template v-slot:item.action="{ props: { item } }">
              <div class="d-flex">
                <Flag
                  ...
                  @update="updateRiskAction(item.id, 'flag', !item.flag)"
                  @updateBookmark="
                  updateBookmarkRiskAction(item.id, !item.bookmarked_pk)"
                  :isShowBookmark="true"
                />
  ...
  methods: {
    ...
    async removeRiskAction(rowId, close) {
      const data = {
        ...
        riskActionId: this.$route.params.riskActionId,
        rowId
      };
    ...
    updateBookmarkRiskAction(rowId, value) {
      const data = {
        idParams: {
          matterId: this.$route.params.matter || this.$route.params.projectId,
          riskActionId: this.$route.params.riskActionId,
      ...
      this.updateBookmarkRiskActionRequest(data);
    },
    ...
    ...mapActions("ht_store/matter/risk/actionEntry", [
      ...
      "updateBookmarkRiskActionRequest",
      //relations
