...
export default {
  ...
  computed: {
    ...mapGetters("ht_store/matter/partient/injury", ["injurys"]), // eslint-disable-line
    ...mapGetters("ht_store/matter/partient/injury/label", ["label"]), // eslint-disable-line
    ...mapGetters("ht_store/matter/partient/tag", ["tags"]), // eslint-disable-line
