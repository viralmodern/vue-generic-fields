...
async function getDocumentDetail(idParams) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/items/${idParams.itemId}/documents/${idParams.pk}/`;
  const result = await get(url);
  return mapObjectResult(result)
}

async function getDataRSID({ idParams, searchObject = {} }) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/documents/`;
  const options = {
...
async function updateRSID({ idParams, body }) {
  ...
  const result = await patch(
    `/api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/documents/${idParams.id}/`,
...
async function removeRSID(payload) {
  return await remove(
    `/api/matters/${payload.matterId}/request-sets/${payload.rSId}/documents/${payload.id}/`
  );
}

async function getDataAttachment({ idParams, query }) {
  const url = `api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/documents/${idParams.rowId}/attachments/`;
  const options = {
    params: query,
  }
  const result = await get(url, options);
...
async function removeAttachment({ matterId, rSId, rowId, attachmentId }) {
  const url = `/api/matters/${matterId}/request-sets/${rSId}/documents/${rowId}/attachments/${attachmentId}/`;
  const result = await remove(url);
  return result;
}

async function getDataNotes({ idParams, query = {} }) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSid}/documents/${idParams.noteId}/notes/`;
  const options = {
    params: query,
  }
  const result = await get(url, options);
...
async function addNotes({ idParams, body }) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSid}/documents/${idParams.rowId}/notes/`;
  const result = await post(url, body);
  return result;
}

async function updateNotes({ idParams, body }) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSid}/documents/${idParams.rowId}/notes/${idParams.noteId}/`;
  const result = await patch(url, body);
  return result;
}

async function removeNotes({ matterId, rSid, rowId, noteId }) {
  const url = `/api/matters/${matterId}/request-sets/${rSid}/documents/${rowId}/notes/${noteId}/`;
  const result = await remove(url);
  return result;
}
...
async function addRSID({ idParams, body }) {
  const result = await post(
    `/api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/documents/`,
    getFormData2(body)
  );
  return mapObjectResult(result);
}
...
async function getDataCommentRSID({ idParams, query = {} }) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/documents/${idParams.id}/${idParams.parentId}/comments/`;
  const options = {
    params: query,
  }
  const result = await get(url, options);
...
async function updateCommentRSID({ idParams, body }) {
  const url = `/api/matters/${idParams.matterId}/request-sets/${idParams.rSId}/documents/${idParams.id}/comments/${idParams.commentId}/`;
  const result = await patch(url, body);
  return result;
}

async function removeCommentRSID({ matterId, rSId, id, commentId }) {
  const url = `/api/matters/${matterId}/request-sets/${rSId}/documents/${id}/comments/${commentId}/`;
  const result = await remove(url);
  return result;
}
