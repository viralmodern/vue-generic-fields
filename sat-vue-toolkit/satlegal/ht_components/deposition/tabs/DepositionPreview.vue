...
import UploadFileDragDrop from "../../uploadFiles/Home";
export default {
  components: {
    UploadFileDragDrop
  },
  methods: {
    ...mapActions("ht_store/matter/discovery/deposition/uploadFiles", [
      "getAllFiles",
      "uploadFiles"
    ]),
  ...
  computed: {
    ...mapGetters("ht_store/matter/discovery/deposition/uploadFiles", ["respTranscript"])
  },
  mounted() {
    const matterId = this.$route.params.matter || this.$route.params.projectId;
    const depositionId = this.$route.params.depositionId;
